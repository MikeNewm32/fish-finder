...
lake_allatoona.fish = [
    Fish.create(name: "Spotted Bass", length: 13, weight: 2, photo: "https://i.imgur.com/Ruup9pHm.jpg"),
    Fish.create(name: "Stripped Bass", length: 24, weight: 7, photo: "https://i.imgur.com/iHZ6Lu6m.jpg"),
    Fish.create(name: "Blue Catfish", length: 36, weight: 20, photo: "https://i.imgur.com/H7wZkSzm.jpg")
]
...
clarks_hill_lake.fish = [
    Fish.create(name: "Largemouth Bass", length: 16, weight: 2, photo: "https://i.imgur.com/LPrr0yZm.jpg"),
    Fish.create(name: "Black Crappie", length: 12, weight: 1, photo: "https://i.imgur.com/IobzQd1m.jpg"),
    Fish.create(name: "Channel Catfish", length: 22, weight: 4, photo: "https://i.imgur.com/tyqxFYLm.jpg")
]

clarks_hill_lake.save
lake_allatoona.save